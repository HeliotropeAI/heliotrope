...
import { AnimatedSprite, WorldMap } from '../../convex/heliotrope/worldMap';
...
export const PixiStaticMap = PixiComponent('StaticMap', {
  create: (props: { map: WorldMap; [k: string]: any }) => {
    ...
    console.log(map.tileSetUrl)
    console.log(map.tileSetUrl);
    const bt = PIXI.BaseTexture.from("/assets/gentle-obj.png", {
    ...
    background.width = screenxtiles * map.tileDim;
    background.height = screenytiles * map.tileDim;
    background.x = 0;
    background.y = 0;
